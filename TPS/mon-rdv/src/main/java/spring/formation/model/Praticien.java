...
public class Praticien extends Individu {
	...
	public Praticien(Civilite civilite, String nom, String prenom, String email, String telephone) {
		super(civilite, nom, prenom, email, telephone);
	}

	public Praticien(Civilite civilite, String nom, String prenom, String email, String telephone,
			Convention convention, boolean carteVitale, boolean cheque, boolean espece, boolean carteBancaire) {
		super(civilite, nom, prenom, email, telephone);
