...
public class MonRdvApplicationTest {
	...
	public void populate() {
		...
		Lieu lieu02 = new Lieu(new Adresse("18 avenue du Général de Gaulle", "", "33290","Blanquefort"), "Cabinet ORL");
		
		lieu02 = MonRdvApplication.getInstance().getLieuRepository().save(lieu02);
		
		Lieu lieu03 = new Lieu(new Adresse("Place Amélie Raba Léon", "Service de consultation ORL", "33000","Bordeaux"), "CHU Pellegrin");
		
		lieu03 = MonRdvApplication.getInstance().getLieuRepository().save(lieu03);
		
		Praticien praticien01 = new Praticien(Civilite.DR, "MAKI", "Raymond", "raymond@gmail.com", "0606066666", Convention.SECTEUR_2, true, false, true, true);
		...
		Praticien praticien02 = new Praticien(Civilite.DRE, "BACHELIER", "dominique", "dominique@gmail.com", "0606066666", Convention.SECTEUR_3, true, true, true, false);
		...
		Consultation consultation01 = new Consultation(LocalDateTime.of(2024, Month.JUNE, 13, 14, 30), 30, "Première Consultation en Médecine Générale", 32.0, Statut.EN_ATTENTE);
		...
		Consultation consultation02 = new Consultation(LocalDateTime.of(2024, Month.JUNE, 15, 9, 0), 20, "Consultation de suivi ORL", 65.0, Statut.CONFIRMER);
